...
{
    // trrgt offset index fixpoint
    public class TrapRegisterGreaterThanRelative : TrapOpCode
    {
        public static readonly HelpString[] Args = { Offset, Index, Fixpoint };

        public TrapRegisterGreaterThanRelative() : base("trrgt") { }
        ...
        {
            return new LocalTrapOperation(chip, lineNumber, source[1], true, source[2], Utils.GreaterThan()).WithFixpoint(source[3]);
        }
