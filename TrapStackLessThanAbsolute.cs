...
{
    // tslt jump dev index fixpoint
    public class TrapStackLessThanAbsolute : TrapOpCode
    {
        public static readonly HelpString[] Args = { Jump, Device, Index, Fixpoint };

        public TrapStackLessThanAbsolute() : base("tslt") { }
        ...
        {
            return new DeviceTrapOperation(chip, lineNumber, source[1], false, source[2], source[3], Utils.LessThan()).WithFixpoint(source[4]);
        }
