...
{
    // trlt jump index fixpoint
    public class TrapRegisterLessThanAbsolute : TrapOpCode
    {
        public static readonly HelpString[] Args = { Jump, Index, Fixpoint };

        public TrapRegisterLessThanAbsolute() : base("trlt") { }
        ...
        {
            return new LocalTrapOperation(chip, lineNumber, source[1], false, source[2], Utils.LessThan()).WithFixpoint(source[3]);
        }
