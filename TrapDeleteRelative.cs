...
namespace Code_Traps
{
    ...
    public class TrapDeleteRelative : ExtendedOpCode
    {
        public static readonly Variable<int> Line = Variables.Int.Named("lineOffset");
        public TrapDeleteRelative() : base("tdeleter") { }
        ...
        {
            return $"Deletes the trap(s) initialized at the specified line offset(s) " +
        ...
        public class TrapDeleteOperation : Operation
        {
            ...
            public override int Execute(int index)
            {
                ...
                for (int i = 0; i < LineGetters.Count; i++)
                {
                    ...
                    ctx.traps.Remove(LineNumber + line);
                }
                return index + 1;
            }
        }
