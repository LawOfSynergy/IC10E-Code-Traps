...
namespace Code_Traps
{
    ...
    public class TrapStackModAbsolute : TrapOpCode
    {
        public static Variable<int> Divisor = Variables.Int.Named("divisor");
        public static readonly HelpString[] Args = { Jump, Device, Index, Divisor, Fixpoint };

        public TrapStackModAbsolute() : base("tsmod") { }
        ...
        {
            return new DeviceTrapOperation(chip, lineNumber, source[1], false, source[2], source[3], Utils.Mod())
                .WithError(source[4])
