...
{
    // trrge offset index fixpoint
    public class TrapRegisterGreaterThanOrEqualRelative : TrapOpCode
    {
        public static readonly HelpString[] Args = { Offset, Index, Fixpoint };

        public TrapRegisterGreaterThanOrEqualRelative() : base("trrge") { }
        ...
        {
            return new LocalTrapOperation(chip, lineNumber, source[1], true, source[2], Utils.GreaterThanOrEqual()).WithFixpoint(source[3]);
        }
