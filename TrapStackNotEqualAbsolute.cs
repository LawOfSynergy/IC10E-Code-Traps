...
{
    // tsne jump dev index fixpoint [error]
    public class TrapStackNotEqualAbsolute : TrapOpCode
    {
        public static readonly HelpString[] Args = { Jump, Device, Index, Fixpoint, Error };

        public TrapStackNotEqualAbsolute() : base("tsne") { }
        ...
        {
            var rv = new DeviceTrapOperation(chip, lineNumber, source[1], false, source[2], source[3], Utils.NotEqual()).WithFixpoint(source[4]);
