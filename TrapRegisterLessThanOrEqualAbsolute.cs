...
{
    // trle jump index fixpoint
    public class TrapRegisterLessThanOrEqualAbsolute : TrapOpCode
    {
        public static readonly HelpString[] Args = { Jump, Index, Fixpoint };

        public TrapRegisterLessThanOrEqualAbsolute() : base("trle") { }
        ...
        {
            return new LocalTrapOperation(chip, lineNumber, source[1], false, source[2], Utils.LessThanOrEqual()).WithFixpoint(source[3]);
        }
