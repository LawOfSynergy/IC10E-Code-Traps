...
{
    // tsc jump dev index
    public class TrapStackChangedAbsolute : TrapOpCode
    {
        public static readonly HelpString[] Args = { Jump, Device, Index };

        public TrapStackChangedAbsolute() : base("tsc") { }
        ...
        {
            return new LocalTrapOperation(chip, lineNumber, source[1], false, source[2], Utils.Changed());
        }
