...
namespace Code_Traps
{
    ...
    public class TrapRegisterModAbsolute : TrapOpCode
    {
        public static Variable<int> Divisor = Variables.Int.Named("divisor");
        public static readonly HelpString[] Args = { Jump, Index, Divisor, Fixpoint };

        public TrapRegisterModAbsolute() : base("trmod") { }
        ...
        {
            return new LocalTrapOperation(chip, lineNumber, source[1], false, source[2], Utils.Mod())
                .WithError(source[3])
