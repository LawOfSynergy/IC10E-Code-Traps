...
{
    // trseq offset dev index fixpoint [error]
    public class TrapStackEqualRelative : TrapOpCode
    {
        ...
        {
            var rv = new DeviceTrapOperation(chip, lineNumber, source[1], true, source[2], source[3], Utils.Equal()).WithFixpoint(source[4]);
