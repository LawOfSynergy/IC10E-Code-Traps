...
{
    // trsle offset dev index fixpoint
    public class TrapStackLessThanOrEqualRelative : TrapOpCode
    {
        public static readonly HelpString[] Args = { Offset, Device, Index, Fixpoint };

        public TrapStackLessThanOrEqualRelative() : base("tsrle") { }
        ...
        {
            return new DeviceTrapOperation(chip, lineNumber, source[1], true, source[2], source[3], Utils.LessThanOrEqual()).WithFixpoint(source[4]);
        }
