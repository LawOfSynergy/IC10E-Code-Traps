...
{
    // tsge jump dev index fixpoint
    public class TrapStackGreaterThanOrEqualAbsolute : TrapOpCode
    {
        public static readonly HelpString[] Args = { Jump, Device, Index, Fixpoint };

        public TrapStackGreaterThanOrEqualAbsolute() : base("tsge") { }
        ...
        {
            return new DeviceTrapOperation(chip, lineNumber, source[1], false, source[2], source[3], Utils.GreaterThanOrEqual()).WithFixpoint(source[4]);
        }
