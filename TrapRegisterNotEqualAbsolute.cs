...
{
    // trne jump index fixpoint [error]
    public class TrapRegisterNotEqualAbsolute : TrapOpCode
    {
        public static readonly HelpString[] Args = { Jump, Index, Fixpoint, Error };

        public TrapRegisterNotEqualAbsolute() : base("trne") { }
        ...
        {
            var rv = new LocalTrapOperation(chip, lineNumber, source[1], false, source[2], Utils.NotEqual()).WithFixpoint(source[3]);
