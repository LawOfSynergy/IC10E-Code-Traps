...
{
    // tsgt jump dev index fixpoint
    public class TrapStackGreaterThanAbsolute : TrapOpCode
    {
        public static readonly HelpString[] Args = { Jump, Device, Index, Fixpoint };

        public TrapStackGreaterThanAbsolute() : base("tsgt") { }
        ...
        {
            return new DeviceTrapOperation(chip, lineNumber, source[1], false, source[2], source[3], Utils.GreaterThan()).WithFixpoint(source[4]);
        }
